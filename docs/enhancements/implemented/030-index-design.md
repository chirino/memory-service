...
status: implemented
supersedes:
  - superseded/002-summarization-design.md
  - partial/019-rename-summary-to-index.md
  - partial/029-search-index-improvements.md
---

# Index Endpoint Redesign

> **Status**: Implemented. Supersedes the indexing approaches in
> [002](../superseded/002-summarization-design.md), [019](../partial/019-rename-summary-to-index.md),
> and [029](../partial/029-search-index-improvements.md).
