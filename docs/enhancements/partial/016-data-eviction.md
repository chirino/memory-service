...
superseded-by:
  ...
  - implemented/039-remove-epoch-eviction.md
---

# Data Eviction (Hard Delete) for Soft-Deleted Resources

> **Status**: Partial. Membership eviction removed by
> [028](../implemented/028-membership-hard-delete.md). Epoch eviction removed by
> [039](../implemented/039-remove-epoch-eviction.md).
...
See [015-task-queue.md](../implemented/015-task-queue.md) for task queue implementation details.
