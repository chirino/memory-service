...
status: partial
superseded-by:
  - implemented/010-drop-resumePosition.md
  - implemented/049-response-resumer-api-simplification.md
---

# Response Cancel Design (Draft)

> **Status**: Partial. Resume position dropped by
> [010](../implemented/010-drop-resumePosition.md). Service and RPC names simplified by
> [049](../implemented/049-response-resumer-api-simplification.md).
