...
superseded-by:
  - implemented/030-index-design.md
---

# Rename Summary to Index and Consolidate Conversation Endpoints

> **Status**: Partial. Supersedes [002](../superseded/002-summarization-design.md). Index model
> further redesigned to per-entry indexing by [030](../implemented/030-index-design.md).
