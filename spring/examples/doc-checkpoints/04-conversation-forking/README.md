...
- Memory service Spring Boot starter with conversation recording
- `ChatController` with memory service integration and conversation history
- `MemoryServiceProxyController` exposing conversation fork APIs:
...
This checkpoint corresponds to the [Conversation Forking](https://github.com/chirino/memory-service/blob/main/site/src/pages/docs/spring/conversation-forking.mdx) guide.
