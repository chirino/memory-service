...
This checkpoint corresponds to the [Response Resumption](https://github.com/chirino/memory-service/blob/main/site/src/pages/docs/spring/response-resumption.mdx) guide.
