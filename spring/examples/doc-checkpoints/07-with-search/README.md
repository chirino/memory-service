...
- Search endpoint added to `MemoryServiceProxyController`:
  - `POST /v1/conversations/search` - Semantic search across conversations

## Tutorial Reference

This checkpoint corresponds to the [Indexing and Search](https://github.com/chirino/memory-service/blob/main/site/src/pages/docs/spring/indexing-and-search.mdx) guide.
