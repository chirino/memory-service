...
import (
	...
	mongostore "github.com/chirino/memory-service/internal/plugin/store/mongo"
...
func setupMongoEpisodicStore(t *testing.T) (registryepisodic.EpisodicStore, context.Context) {
	t.Helper()
...
func TestIncrementMemoryLoads_DedupesPerRequest_Mongo(t *testing.T) {
...
func TestListTopMemoryUsage_SortAndPrefix_Mongo(t *testing.T) {
	store, ctx := setupMongoEpisodicStore(t)
