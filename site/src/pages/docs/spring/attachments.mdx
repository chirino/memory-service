...
**Completed code**: View the full implementation at [spring/examples/doc-checkpoints/08-with-attachments](https://github.com/chirino/memory-service/tree/main/spring/examples/doc-checkpoints/08-with-attachments)

For a complete working example with attachments integrated into the chat flow (including multi-modal LLM support), see the [spring/examples/chat-spring](https://github.com/chirino/memory-service/tree/main/spring/examples/chat-spring) directory.
