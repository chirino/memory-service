...
- Complete the [Conversation Forking](./conversation-forking) and [Response Resumption](./response-resumption) guides
...
The membership endpoints are already available in checkpoint 06 through the `MemoryServiceProxyController`:
