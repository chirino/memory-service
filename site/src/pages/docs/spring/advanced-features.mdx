...
<TestScenario checkpoint="spring/examples/doc-checkpoints/04-advanced-features">
...
**Completed code**: View the full implementation at [spring/examples/doc-checkpoints/04-advanced-features](https://github.com/chirino/memory-service/tree/main/spring/examples/doc-checkpoints/04-advanced-features)
