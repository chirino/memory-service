...
That means the file you update is the one that sets environment variables before the app starts. If you keep those in a `.env` file next to the app, it should look like this:

<CodeFromFile file="python/examples/langchain/doc-checkpoints/05-response-resumption/docs-snippets/.env" lang="bash" />
