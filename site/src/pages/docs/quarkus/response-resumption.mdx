...
<CodeFromFile
  file="java/quarkus/examples/doc-checkpoints/05-response-resumption/src/main/java/org/acme/Agent.java"
  lang="java"
/>
...
<CodeFromFile
  file="java/quarkus/examples/doc-checkpoints/05-response-resumption/src/main/java/org/acme/HistoryRecordingAgent.java"
  lang="java"
/>
...
<CodeFromFile
  file="java/quarkus/examples/doc-checkpoints/05-response-resumption/src/main/java/org/acme/ChatResource.java"
  lang="java"
/>
...
`} exampleOutputLang="text" exampleOutput={`Once upon a time, there was a curious little cat named Whiskers who loved to explore the garden behind her cozy cottage. Every morning, she would stretch lazily in the sunlight before venturing out to discover what new wonders the day might bring.
...
<CodeFromFile
  file="java/quarkus/examples/doc-checkpoints/05-response-resumption/src/main/java/org/acme/ResumeResource.java"
  lang="java"
/>
