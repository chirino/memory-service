...
```bash
curl -NsSfX POST http://localhost:9090/chat/b2c3d4e5-f6a7-4b8c-9d0e-1a2b3c4d5e6f \
  -H "Content-Type: text/plain" \
...
If you browse to the demo agent app at [http://localhost:8080/](http://localhost:8080/), you will see that a conversation has been created with the ID `b2c3d4e5-f6a7-4b8c-9d0e-1a2b3c4d5e6f`.
