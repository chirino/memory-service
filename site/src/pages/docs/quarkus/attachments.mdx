...
**Completed code**: View the full implementation at [quarkus/examples/doc-checkpoints/08-with-attachments](https://github.com/chirino/memory-service/tree/main/quarkus/examples/doc-checkpoints/08-with-attachments)

For a complete working example with attachments integrated into the chat flow (including multi-modal LLM support), see the [quarkus/examples/chat-quarkus](https://github.com/chirino/memory-service/tree/main/quarkus/examples/chat-quarkus) directory.
