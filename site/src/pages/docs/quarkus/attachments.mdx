...
<CodeFromFile
  file="java/quarkus/examples/doc-checkpoints/08-with-attachments/src/main/java/org/acme/AttachmentsProxyResource.java"
  lang="java"
/>
...
<CodeFromFile
  file="java/quarkus/examples/doc-checkpoints/08-with-attachments/src/main/java/org/acme/AttachmentDownloadProxyResource.java"
  lang="java"
/>
...
<CodeFromFile
  file="java/quarkus/examples/doc-checkpoints/08-with-attachments/src/main/resources/application.properties"
  lang="properties"
  before={1}
  after={1}
...
<TestScenario checkpoint="java/quarkus/examples/doc-checkpoints/08-with-attachments">
...
"""
`} exampleOutputLang="json" exampleOutput={`{"contentType":"text/plain","expiresAt":"2026-03-06T15:59:00Z","filename":"test-upload.txt","href":"/v1/attachments/315e31ba-805b-4508-88ab-f197b0050030","id":"315e31ba-805b-4508-88ab-f197b0050030","sha256":"45756124416f43c4c9c5138fb2909cea45ae20b9852e9def468370906be6c84a","size":20,"status":"ready"}`}>
...
Hello, attachments!
"""
`} exampleOutputLang="json" exampleOutput={`{"expiresIn":300,"url":"/v1/attachments/download/MTcwNDd8MTc3MjgwOTQ0MA.iqQWNgAkLznmmHRC49o14ixpZfvrE_Xl-1yWSRmpqKA/test-upload.txt"}`}>
