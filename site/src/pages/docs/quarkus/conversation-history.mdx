...
<CodeFromFile
  file="java/quarkus/examples/doc-checkpoints/03-with-history/src/main/java/org/acme/HistoryRecordingAgent.java"
  lang="java"
/>
...
<TestScenario checkpoint="java/quarkus/examples/doc-checkpoints/03-with-history">
...
<CodeFromFile
  file="java/quarkus/examples/doc-checkpoints/03-with-history/pom.xml"
  lang="xml"
  before={2}
  after={1}
...
**Completed code**: View the full implementation at [java/quarkus/examples/doc-checkpoints/03-with-history](https://github.com/chirino/memory-service/tree/main/java/quarkus/examples/doc-checkpoints/03-with-history)
