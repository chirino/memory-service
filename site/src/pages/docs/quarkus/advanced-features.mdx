...
<TestScenario checkpoint="quarkus/examples/doc-checkpoints/04-advanced-features">
...
**Completed code**: View the full implementation at [quarkus/examples/doc-checkpoints/04-advanced-features](https://github.com/chirino/memory-service/tree/main/quarkus/examples/doc-checkpoints/04-advanced-features)
