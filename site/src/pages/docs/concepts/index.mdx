...
### [Agent and Sub-Agent Workflows](/docs/concepts/agent-subagent-workflows/)

Use parent and child conversations to delegate sub-tasks between logical agents, keep agent context isolated, and inspect delegated work separately from forks.
...
Administrative APIs for cross-user access, audit logging, and data lifecycle management. Covers admin and auditor roles, justification fields, and eviction of archived data.
