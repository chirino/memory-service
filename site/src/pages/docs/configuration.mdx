...
| Flag | Values | Default | Description |
|------|--------|---------|-------------|
| <Cfg p="--policy-dir" e="MEMORY_SERVICE_POLICY_DIR" /> | path | built-in policies | Directory containing memory OPA/Rego policy files: `authz.rego`, `attributes.rego`, `filter.rego` |
