...
**Why**: Sharing operations are delegated to Memory Service through a thin authenticated proxy layer.
...
**Why**: Access control rules stay centralized in Memory Service while the app exposes a frontend-friendly API surface.
...
**Why**: Ownership transfer is a multi-step flow; exposing all four operations lets clients complete that lifecycle.
