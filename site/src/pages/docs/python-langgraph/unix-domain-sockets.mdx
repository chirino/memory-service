...
Set the socket path in the file that supplies environment variables for the running process. If you keep those in a `.env` file next to the app, it should look like this:

<CodeFromFile file="python/examples/langgraph/doc-checkpoints/05-response-resumption/docs-snippets/.env" lang="bash" />
