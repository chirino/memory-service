...
<CodeFromFile
  ...
  lang="python"
  match="async def list_conversations"
  before={1}
  after={8}
/>
...
And the response should contain "accessLevel"
And the response should contain "owner"
`} exampleOutputLang="json" exampleOutput={`{"afterCursor":null,"data":[{"id":"819753ab-b3ac-42f8-89fb-dd02ec7f4a30","conversationId":"53d23c96-6b29-4fbb-879d-db18bf4d94ff","userId":"bob","channel":"history","contentType":"history","createdAt":"2026-03-06T14:58:32.782652Z","content":[{"role":"USER","text":"Give me a random number between 1 and 100."}]},{"id":"4ff191fc-4663-46d5-bf66-e62758e760ec","conversationId":"53d23c96-6b29-4fbb-879d-db18bf4d94ff","userId":"bob","channel":"history","contentType":"history","createdAt":"2026-03-06T14:58:32.851076Z","content":[{"role":"AI","text":"42"}]}]}`}>
