...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 not-prose mt-6">
  ...
  <a href="integrations/quarkus/" class="card p-4 hover:border-primary-500 transition-colors">
    <h3 class="font-semibold text-gray-900 dark:text-white">Integrations</h3>
    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Quarkus extension, LangChain4j, and APIs</p>
  </a>
</div>
