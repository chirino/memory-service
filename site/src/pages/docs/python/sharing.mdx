...
```bash
curl -sSfX POST http://localhost:9090/chat/2380a370-09c5-468d-965f-f247af507833 \
...
```bash
curl -sSfX GET http://localhost:9090/v1/conversations/2380a370-09c5-468d-965f-f247af507833/memberships \
...
```bash
curl -sSfX POST http://localhost:9090/v1/conversations/2380a370-09c5-468d-965f-f247af507833/memberships \
  -H "Authorization: Bearer $(get-token bob bob)" \
...
curl -sSfX POST http://localhost:9090/v1/ownership-transfers \
  ...
  -H "Content-Type: application/json" \
  -d '{
    "conversationId": "2380a370-09c5-468d-965f-f247af507833",
