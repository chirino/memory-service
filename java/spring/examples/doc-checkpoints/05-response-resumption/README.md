...
- Streaming `ChatController` using `Flux<String>` and `SseEmitter`
- `ResumeController` exposing resume/cancel APIs:
...
This checkpoint corresponds to the [Response Recording and Resumption](https://github.com/chirino/memory-service/blob/main/site/src/pages/docs/spring/response-resumption.mdx) guide.
