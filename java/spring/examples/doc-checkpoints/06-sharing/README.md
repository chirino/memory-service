...
This checkpoint corresponds to the [Conversation Sharing](https://github.com/chirino/memory-service/blob/main/site/src/pages/docs/spring/sharing.mdx) guide.
...
For a production-ready example with frontend, see [java/spring/examples/chat-spring](../../chat-spring/).
