...
- OpenAPI `readOnly: true` fields generate Java response-model getters without setters or fluent builder methods. Tests that construct generated response models must not populate those fields through methods such as `.id(...)`.
